...
Write-Host "$YELLOW  关注公众号【科技源代码Code】 $NC"
Write-Host "$YELLOW  一起交流更多Cursor技巧和AI知识(脚本免费、关注公众号加群有更多技巧和大佬)  $NC"
Write-Host "$YELLOW  [重要提示] 本工具免费，如果对您有帮助，请关注公众号【科技源代码Code】  $NC"
Write-Host "$BLUE================================$NC"
Write-Host ""
...
try {
    ...
    Write-Host ""
    Write-Host "$GREEN================================$NC"
    Write-Host "$YELLOW  关注公众号【科技源代码Code】一起交流更多Cursor技巧和AI知识(脚本免费、关注公众号加群有更多技巧和大佬)  $NC"
    Write-Host "$GREEN================================$NC"
    Write-Host ""
